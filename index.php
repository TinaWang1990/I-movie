...
<html lang="en">
  <head>
    ...
    .H2 {
    	...
    	height: 20vh;
    	width: 80vw;
    	position: fixed; top:48vh; left: 20vw;
    }
    .H2 row{
    	padding: 0;
    	margin: 0;
  ...
  <body>
    <div class="d-flex flex-column">
  		<div class="bg-dark container " style="margin: 0; width: 100vw; height: 50px">
  			
  			<div class="row bg-dark text-white text-center" style="margin: 0; width: 100vw; height: 50px; line-height: 50px" >
  		...
  		<div class="H1">
			...
			<div class=" " style="position: absolute; top:30vh; left: 25vw;width: 60vw; ">
  			...
  			<div class="row">
  				<div class="col-2.4"><img src="./ready player one poster.jpg" style=""></div>
  				<div class="col-2.4"><img src="./ready player one poster.jpg" style=""></div>
  				<div class="col-2.4"><img src="./ready player one poster.jpg" style=""></div>
  				<div class="col-2.4"><img src="./star wars-poster.jpg" style=""></div>
  				<div class="col-2.4"><img src="./ready player one poster.jpg" style=""></div>
