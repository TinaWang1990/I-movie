...
<!-- 
   ...
   <div class="B-H1 container-fluid p-0" style="background-image: url(./img/ready background.jpg);">
 	 	...
 	 	<div class="row m-0 p-0">
 	 		...
 	 		<div class="col-7">
 	 			<div class="movie-info">
 	 				<h1>Ready Player One (2018)</h1>
 	 				<span class="tag">Fiction</span> | <span class="movie-duration">98 Min</span>
 	 ...
 	 <div class="B-H3 container-fluid p-0">
 	 	...
 	 	<div class="col-7">
 	 		...
 	 		<div class="trailor text-dark">
 	 			...
 	 			<div style="box-shadow: 3px 3px 5px 6px #000;"><iframe width="100%" height="400" src="https://www.youtube.com/embed/cSp1dM2Vj48" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>
 	 		</div>
 	 	</div>
 	 	</div>
 	 </div>
 	 <div class="B-H4 container-fluid px-5 pt-5">
 	 	...
 	 	<div class="row">
 	 		 <form class="form-inline my-5 mx-auto">
   				<textarea class="form-control" type="text-area" rows="4" placeholder="Write Your Comments Here" style="width:50vw"></textarea>
   				<div class="ml-3" style="align-self: flex-end; ">
   					<button class="btn " type="submit" style="background-color:#fe7900 ">Submit</button>
   				</div>
    		</form>
 	 	</div>
 	 </div>
